...
**The Config Object:** Defines how the records are to be used. It's properties are:
  ...
  - <strong>props:</strong> The fields that will be used (i.e. title, author, image); this property is more descriptive than functional (like a schema), and defines the terms that will be used. Example: ['author', 'image', description']
